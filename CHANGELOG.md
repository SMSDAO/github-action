...
For historical changelogs, see the [GitHub releases page](https://github.com/SMSDAO/github-action/releases/).
...
- `docs/guides/admin-guide.md` — access governance, billing controls, audit logging, security configuration
- `docs/guides/developer-guide.md` — build system internals, CI/CD pipeline, debugging, contributing
- `docs/assets/ui/` — conceptual dashboard mockup screenshots: user, admin, and developer views
...
- `README.md`: added `Documentation` section linking to all docs and `UI Preview` section with mockup screenshots
